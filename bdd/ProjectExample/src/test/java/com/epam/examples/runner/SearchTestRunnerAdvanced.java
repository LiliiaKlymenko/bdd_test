...
public class SearchTestRunnerAdvanced extends JUnitStories {
   ...
   // private WebDriver driverProvider = new InternetExplorerDriver();
    private WebDriverSteps lifecycleSteps = new PerStoriesWebDriverSteps(
            (WebDriverProvider) driverProvider);
    private PageFactory pageFactory = new PageFactory( (WebDriverProvider) driverProvider);
    ...
    public Configuration configuration() {
        return new SeleniumConfiguration()
            ...
            .useWebDriverProvider( (WebDriverProvider) driverProvider)
    ...
    public InjectableStepsFactory stepsFactory() {
        ...
        return new InstanceStepsFactory(configuration, new SearchSteps(
            pageFactory), lifecycleSteps, new WebDriverScreenshotOnFailure(
                (WebDriverProvider) driverProvider, configuration.storyReporterBuilder()));
    }
